...
urlpatterns = [
    ...
    path('posts_update_view/<int:pk>/', PostUpdateView.as_view(), name='posts_update_view'),
    path('posts_delete_view/<int:pk>/', PostDeleteView.as_view(), name='posts_delete_view'),
]